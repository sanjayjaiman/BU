...
public class ArrayList<E> implements List<E> {
  ...
  public void addAll(ArrayList<E> newE) throws IndexOutOfBoundsException {
      for (int i = 0; i < newE.size(); i++) {
          E element = newE.get(i);
          add(size(), element);
      }
  }
  ...
  public E remove(E element) throws IndexOutOfBoundsException {
      Iterator<E> iter = iterator();
      int i = 0;
      while(iter.hasNext()) {
          E li = iter.next();
//          System.out.println("Comapre " + li + " AND " + element);
          
          if (li.equals(element)) {
//              return remove(i);    // This uses previously defined method remove(int)
                iter.remove();      // This is slicker
                return li;
          }
//          i++;
      }
